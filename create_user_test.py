...
def negative_assert_no_first_name(user_body):  #
    response = sender_stand_request.post_new_user(user_body)  # В response сохраняет ответ
    # Проверка, что код ответа равен 400
    assert response.status_code == 400
    # Проверка, что в теле ответа атрибут "code" равен 400
    assert response.json()["code"] == 400
...
# Тест 5. Успешный
# Создание пользователя Имя состоит из Английских символов
...
# Параметр firstName создержит пробел
...
# Тест 9 Ошибка
# Создание юзера. Параметр FirstName содердит число
